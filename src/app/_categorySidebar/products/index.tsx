...
export const Route = createFileRoute("/_categorySidebar/products/")({
...
function RouteComponent() {
  ...
  return (
    <div className="flex flex-grow font-mono">
      <aside className="fixed left-0 hidden w-64 max-w-64 min-w-64 overflow-y-auto border-r p-4 md:block md:h-full">
